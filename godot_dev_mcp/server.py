...
CORE_TOOLS = [
    ...
    _tool("godot_runtime_snapshot", "Read the runtime tree and selected performance monitors.", {"monitors": {"type": "array", "items": {"type": "string"}, "maxItems": 16}}),
...
def dispatch(tools: GodotTools, message: dict[str, Any]) -> dict[str, Any] | None:
    ...
    try:
        handlers: dict[str, Callable[[], Any]] = {
            ...
            "godot_runtime_snapshot": lambda: tools.runtime_snapshot(arguments.get("monitors")),
